...
const Weather = () => {
    const getDays = () => {
        return [{
                ...
                id: 2,
                name: "Acta de entrega de equipo",
                
                weather: WeatherType.Sunny
            }, {
                id: 3,
                name: "Formato de ingreso de activo",
                
                weather: WeatherType.Cloudy
            }, {
                id: 4,
                name: "Formato de retiro de activos",
               
                weather: WeatherType.Rainy
            }, {
                id: 5,
                name: "Formato de traslado de activos",
                
                weather: WeatherType.Stormy
            }, {
                id: 6,
                name: "Formato de prestamo de quipos",
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-sun", id: "weather-section", scrollable: true, title: "Tramites de AREA TI" }, getDays()));
};
const Tools = () => {
    const getTools = () => {
        return [{
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-toolbox", id: "tools-section", title: "Base de datos TI" }, getTools()));
};
const Restaurants = () => {
    const getRestaurants = () => {
        return [{
                ...
                desc: "Informacion general",
                id: 2,
                image: "./img/servidores.jpg",
                title: "Base de Datos"
            }, {
                desc: "acsesorios",
                id: 3,
                image: "./img/inventario.jpg",
                title: "Inventario"
            }, {
                desc: "Frecuencia",
                id: 4,
                image: "./img/informes.jpg",
                title: "Informes"
            }].map((restaurant) => {
            const styles = {
    ...
    return (React.createElement(MenuSection, { icon: "fa-regular fa-pot-food", id: "restaurants-section", title: "Area TI" }, getRestaurants()));
};
const Movies = () => {
    const getMovies = () => {
        return [{
                ...
                image: "./img/documental.jpg",
                title: "Administrativo"
            }, {
                desc: "",
                id: 2,
                icon: "fa-solid fa-starship-freighter",
                image: "./img/formatos.jpg",
                title: "Formatos"
            }, {
                desc: "",
                id: 3,
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-camera-movie", id: "movies-section", scrollable: true, title: "Gestor documental" }, getMovies()));
};
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" },
                ...
                React.createElement("a", { id: "youtube-link", className: "clear-button", href: "http://10.0.0.8/INDANET/", target: "_com" },
                    React.createElement("i", { className: "fa-brands fa-youtube" }),
                    React.createElement("span", null, "INDANET Comestiblesdan")),
